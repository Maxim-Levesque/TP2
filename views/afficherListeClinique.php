        ...
        <form method="">
            <?php
                foreach ($listeClinique as $clinique) 
                {
                    ...
                    echo '<td><input value="Modifier" onclick="document.getElementById(\'nomClinique\').value =\'' . $clinique->getNom() . '\'; this.form.action=\'cliniqueController.php\'; this.form.method=\'GET\'; document.getElementById(\'action\').value=\'formulaireModifierClinique\'; submit();" type="button"></td>';
